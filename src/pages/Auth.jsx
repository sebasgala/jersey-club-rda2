        ...
        <div className="w-full max-w-sm">
            ...
            <form onSubmit={handleSubmit} noValidate>
              ...
              <div className="mb-3">
                <div className="flex items-center justify-between mb-1">
                  <label htmlFor="password" className="block text-xs font-bold text-[#0F1111]">
                    Contraseña
                  </label>
                  <Link to="#" className="text-[10px] text-[#0066c0] hover:text-[#c45500] hover:underline">
              ...
              <button
                type="submit"
                disabled={isLoading}
                className={`w-full py-1.5 px-4 text-sm font-medium rounded-[3px] border transition-all duration-150 ${isLoading
          ...
          <div className="relative my-3">
            ...
            <div className="relative flex justify-center">
              <span className="bg-gray-50 px-3 text-[10px] text-gray-500 uppercase tracking-tight">¿Eres nuevo en Jersey Club?</span>
            </div>
          </div>

          <Link
            to="/register"
            className="block w-full py-1.5 px-4 text-sm font-medium text-center text-white bg-[#BF1919] border border-[#BF1919] rounded-[3px] hover:bg-[#a81414] transition-all"
          >
