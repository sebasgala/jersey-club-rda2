                ...
                <div className="grid grid-cols-2 gap-2">
                  <div>
                    ...
                    <input
                      ...
                      disabled={isLoading || submitSuccess}
                      className={`w-full px-3 py-1.5 text-sm border rounded-[3px] outline-none transition-all ${errors.password && touched.password
                  ...
                  <div>
                    ...
                    <input
                      ...
                      placeholder="Repite"
                      disabled={isLoading || submitSuccess}
                      className={`w-full px-3 py-1.5 text-sm border rounded-[3px] outline-none transition-all ${errors.confirmPassword && touched.confirmPassword
                        ? 'border-red-500' : 'border-gray-400 focus:border-[#e77600]'
                        } ${isLoading || submitSuccess ? 'bg-gray-100' : 'bg-white'}`}
                    />
                  </div>
