        ...
        <div className="categories-grid">
          <article className="category-card">
            <Link to="/futbol?filter=temporada2025" style={{ textDecoration: 'none', color: 'inherit' }}>
              <img src="/assets/images/manchester-city-2026-local.webp" alt="Temporada 2025" className="category-image" loading="lazy" />
          ...
          <article className="category-card">
            <Link to="/formula1?filter=edicionlimitada" style={{ textDecoration: 'none', color: 'inherit' }}>
              <img src="/assets/images/ferrari-f1-team-2025.webp" alt="Edición Limitada F1" className="category-image" loading="lazy" />
          ...
          <article className="category-card">
            <Link to="/jersey-club-brand" style={{ textDecoration: 'none', color: 'inherit' }}>
              <img src="/assets/images/buzo-compresion-hombre-jersey-club.webp" alt="Colección Exclusiva" className="category-image" loading="lazy" />
          ...
          <article className="category-card">
            <Link to="/product/fb-portugal-2004-local-retro" style={{ textDecoration: 'none', color: 'inherit' }}>
              <img src="/assets/images/portugal-2004-local-retro.webp" alt="Portugal 2004 Local RETRO" className="category-image" loading="lazy" />
            ...
            <div className="category-footer"><Link to="/product/fb-portugal-2004-local-retro">Ver más</Link></div>
          </article>
        </div>
      </div>
    </section>
